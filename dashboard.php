<?php 
    ...
    if (!isset($_SESSION["user"])) {
        $_SESSION["message"] = "Invalid login! Please login again.";
...
<body>
    <main class="container">
        ...
        <section class="panel">
            <h2 class="panel-heading">Logged in as <?= $user ?>!</h2>
            ...
            <form class="panel-form" action="logout.service.php" method="post">
                <input class="panel-form-button" type="submit" name="submit" value="Logout">
            </form>
        </section>
    </main>
    <footer class="footer">
